    ...
    Views: {
      ...
      cross_asset_conflict_replay_validation_snapshots: {
        Row: {
          ...
          conflict_delta: Record<string, unknown>;
          conflict_composite_delta: Record<string, unknown>;
          drift_reason_codes: string[];
          validation_state: string;
          metadata: Record<string, unknown>;
          created_at: string;
        };
        Insert: Partial<Database["public"]["Tables"]["cross_asset_conflict_replay_validation_snapshots"]["Row"]> & {
          workspace_id: string; watchlist_id: string; source_run_id: string; replay_run_id: string;
        };
        Update: Partial<Database["public"]["Tables"]["cross_asset_conflict_replay_validation_snapshots"]["Row"]>;
        Relationships: [];
      };
      cross_asset_family_conflict_replay_stability_snapshots: {
        ...
        Insert: Partial<Database["public"]["Tables"]["cross_asset_family_conflict_replay_stability_snapshots"]["Row"]> & {
          workspace_id: string; watchlist_id: string; source_run_id: string; replay_run_id: string; dependency_family: string;
        };
        Update: Partial<Database["public"]["Tables"]["cross_asset_family_conflict_replay_stability_snapshots"]["Row"]>;
        Relationships: [];
      };
      cross_asset_conflict_replay_validation_summary: {
        Row: Database["public"]["Tables"]["cross_asset_conflict_replay_validation_snapshots"]["Row"];
        Relationships: [];
      };
      cross_asset_family_conflict_replay_stability_summary: {
        Row: Database["public"]["Tables"]["cross_asset_family_conflict_replay_stability_snapshots"]["Row"];
        Relationships: [];
      };
      cross_asset_conflict_replay_stability_aggregate: {
        Row: {
          workspace_id: string;
          validation_count: number;
          context_match_rate: number | string | null;
